...
#        if _debug: ReadPropertyApplication._debug("confirmation %r", apdu)
        str_object_type = str(apdu.objectIdentifier[0])
        str_object_inst = str(apdu.objectIdentifier[1])
        sys.stdout.write(str(str_object_type) + '\n')
        sys.stdout.write(str(str_object_inst) + '\n')
